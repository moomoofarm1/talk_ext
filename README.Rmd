...
[![Github build status](https://github.com/oscarkjell/talk/workflows/R-CMD-check/badge.svg)](https://github.com/oscarkjell/talk/actions)
[![Project Status: Active – The project has reached an experimental, usable state and is being actively developed](https://www.repostatus.org/badges/latest/experimental.svg)](https://www.repostatus.org/#active)
...
devtools::install_github("oscarkjell/talk")
```
